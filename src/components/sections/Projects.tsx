...
const allProjects = [
  ...
  { name: "Contractr",       tagline: "B2B Manpower Marketplace",         description: "Full-featured B2B Manpower Marketplace with three portals (Vendor, Company, Admin) featuring role-based protected routing, dashboards, application tracking, contract management, and real-time notifications.",       stack: ["React.js","Redux Toolkit","React Router v6","Tailwind CSS","Framer Motion"],       category: ["Full Stack","Frontend"], accent: "#f59e0b", number: "04" },
  ...
  { name: "IPEL",            tagline: "Digital Repository",               description: "Centralized repository managing project documents, resources, images, and videos with real-time dynamic dashboards to monitor and visualize key project initiative metrics.",                                             stack: ["React.js","Redux","Node.js","Express.js","MongoDB"],                               category: ["Full Stack"],            accent: "#6366f1", number: "07" },
  { name: "Novaite",         tagline: "AI-Driven Digital Platform",       description: "AI-driven digital solutions platform automating business operations with GraphQL APIs and Directus CMS integration for enhanced customer engagement.",                                                                    stack: ["React.js","GraphQL","Directus"],                                                   category: ["Frontend"],              accent: "#ef4444", number: "08" },
  { name: "SuperGlassEast FL",tagline: "Glass Restoration Platform",      description: "Full-stack business website for a certified mobile glass restoration franchise with SEO-optimized metadata, Open Graph tags, mobile-first design, and lead generation features.",                                        stack: ["HTML","CSS","JavaScript","Responsive Design","SEO"],                               category: ["Frontend"],              accent: "#f97316", number: "09" },
  { name: "CKARE",           tagline: "Clinic Management App",            description: "Full-featured clinic management SPA with payment gateway integration and barcode generation for streamlined operations serving Pro and Member users.",                                                                    stack: ["React.js","Redux","Bootstrap","Material UI"],                                      category: ["Full Stack"],            accent: "#d946ef", number: "10" },
  { name: "POLITIX",         tagline: "Live Streaming Platform",          description: "Political video and live streaming platform enabling user-generated content creation, live broadcasting, and content moderation to democratize political journalism.",                                                    stack: ["React.js","Redux","Bootstrap","Material UI"],                                      category: ["Frontend"],              accent: "#8b5cf6", number: "11" },
];
    ...
    <section id="projects" ref={ref} className="py-32 relative overflow-hidden" data-testid="projects-section">
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px]"
          style={{ background: `radial-gradient(circle,${isDark ? "rgba(124,58,237,0.04)" : "rgba(124,58,237,0.025)"},transparent)` }}
        />
      </div>
